insert into colrq_timetrack values('complete1m4_selectopt','y','n','n','n',4,'n',TIMESTAMP 'now')
...
CREATE TABLE reqa AS SELECT DISTINCT   * FROM R1 UNION ALL SELECT * FROM R2 UNION ALL SELECT * FROM R3 UNION ALL SELECT * FROM R4
