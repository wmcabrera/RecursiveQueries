 ...
 * 
 * file=input.txt;O1=Y;O2=Y;O3=Y;O4=Y;database=row;intermediateProjections=Y;createBuckets=Y
 */
...
public class rq {
	...
	private static void apply_Optimizations(HelperFunctions helper,String[] queries,Optimizations opt) {
		...
		String rcountquery="SELECT COUNT(*) FROM "+tableName;
		System.out.println("Number of rows in "+tableName+" table: "+helper.executeQuery(rcountquery));
